...
4. **FR-001: プロジェクト初期化 (`init`)** - Partially implemented but missing key elements:
   - Doesn't copy `GuidlineCodingTesting.md` as specified in the guidelines
...
1. **FR-001: `init` (プロジェクト初期化)** - Partially implemented:
   ...
   - Doesn't copy `GuidlineCodingTesting.md` as specified
...
### Documentation Standards (GuidlineCodingTesting.md)
